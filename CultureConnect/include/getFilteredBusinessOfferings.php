...
$bus_id = $_GET['businessIdPk'] ?? [];    //return selected locations or an empty array

$filter_query = "SELECT * FROM view_offerings WHERE businessName = 
                    (SELECT businessName from business WHERE businessIdPk=" . $bus_id . ") 
                    ORDER BY offeringName";                   //TODO: Fix against SQL injection
