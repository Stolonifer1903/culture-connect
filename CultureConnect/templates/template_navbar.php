            ...
            <?php
                if (isset($_SESSION['role'])) {
                    if ($_SESSION['role'] == 1) {
                        ...
                        echo "  <a id='home' class='nav-link d-inline' href='00Home.php'>Home</a>
                                <a id='edit_profile' class='nav-link d-inline' href='02ManageUser.php'>Edit profile</a>
                                <a id='edit_busines' class='nav-link d-inline' href='97ManageBusinessAdmin.php'>Edit business details</a>
                                <a id='edit_busines' class='nav-link d-inline' href='97ManageCouncilAdmin.php'>Edit council details</a>
