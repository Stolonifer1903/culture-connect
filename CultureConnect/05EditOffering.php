...
<body onload="toggleFieldsEditOffering('product')">
    ...
    <!--Page heading-->
    <section class = "text-left py-5" style="background-color:#ACC8A2;"><div class="container"><h1>Product or service details</h1></div></section>
    <!-- Main content -->
        ...
        <div class="container">
            ...
            <form id="editoffering" name="editoffering" action="include\updateOffering.php" method="post">
                <table class="table" >
                    <!--Product or service-->
                    <tr>
                        <td width="20%"><label for="offering_type" style="margin-right:25px">Offering type:</label></td> <!--TODO: FIND BETTER NAME-->
                        <td>
                            <input type="radio" id="product" name="offering_type" value="1" onclick="toggleFieldsEditOffering(this.id)" checked >
                            <label for="product" style="margin-right:25px">Product </label>
                            <input type="radio" id="service" name="offering_type" value="2" onclick="toggleFieldsEditOffering(this.id)">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p>If a category is not shown, another business already has a product or service for offer in the location</p>
                        </td>
                    </tr>
                    <!-- Offering name -->
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><textarea id="description" name="description" rows="4" cols="68" maxlength="300"></textarea></td>
                    </tr>
                    <!-- Details -->
                    <tr id="details">
                        <td><label for="details">Details:</label></td>
                        <td><textarea id="details" name="details" rows="4" cols="68" maxlength="300" placeholder="Enter size and quantity options for products and dates and times for services"></textarea></td>
                    </tr>
                    <!-- Cultural benefits -->
                    <tr>
                        <td><label for="cultural_benefit">Cultural benefit:</label></td>
                        <td><textarea id="cultural_benefit" name="cultural_benefit" rows="4" cols="68" maxlength="300"></textarea></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><table>
                            <tr>
                                <td>
                                <input class='btn btn-custom btn-sm' style="margin-right:25px;" type="submit" value="Submit" name="submit">
