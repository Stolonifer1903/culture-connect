...
(1, 'MyBusiness', 'testy\r\ntesty\r\ntest1234564', 'mybusiness@bus.com', 123456, 'myb.bus.com', 8),
(2, 'Monica\'s Mugs', 'testy\r\ntesty\r\ntest1234564', 'info@monsmugs.co.uk', 123456, 'monsmugs.co.uk', 10);
...
(1, 'Beautiful handmade ceramics\r\n', 'Beautiful ceramics handmade in Hatfield that represent the countryside around the area', 'Mugs - £15 each\r\nPlates - £10 each', 'We are keeping traditional ceramics alive by staying true to centuries old methods.', '', 1, 14, 2, 2),
(3, 'Handmade prints', 'Beautiful handmade prints from a local WGC artist', 'Multiple sizes available\r\nWith or without framing', 'some words here', '', 2, 13, 1, 1),
(4, 'Beautiful handmade ceramics\r\n', 'Beautiful ceramics handmade in Hatfield that represent the countryside around the area', 'Mugs - £15 each\r\nPlates - £10 each', 'We are keeping traditional ceramics alive by staying true to centuries old methods.', '', 1, 14, 2, 2),
(5, 'Handmade prints', 'Beautiful handmade prints from a local WGC artist', 'Multiple sizes available\r\nWith or without framing', 'some words here', '', 2, 13, 1, 1),
(6, 'Service', 'Service', 'Line1\r\nLine2', 'some words here', '', 1, 4, 1, 1);
...
(11, 'Bob', 'Jones', 'counc2@counc.com', '1234', '', 3, 7);
...
--
ALTER TABLE `business`
  MODIFY `businessIdPk` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `location`
  MODIFY `locationIdPk` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `offering`
--
ALTER TABLE `offering`
  MODIFY `offeringIdPk` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `resident`
--
ALTER TABLE `resident`
  MODIFY `residentIdPk` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `residentinterests`
--
ALTER TABLE `residentinterests`
  MODIFY `residentInterestIdPk` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `userIdPk` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `resident`
  ADD CONSTRAINT `resident_ibfk_1` FOREIGN KEY (`locationIdPk`) REFERENCES `location` (`locationIdPk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `resident_ibfk_2` FOREIGN KEY (`userIdPk`) REFERENCES `user` (`userIdPk`) ON DELETE CASCADE ON UPDATE CASCADE;
